...
namespace Savelyev_Глазки_save
{
    ...
    public partial class SavelyevEntities : DbContext
    {
        private static SavelyevEntities _context;

        public static SavelyevEntities GetContext()
        {
            if (_context == null)
            {
                _context = new SavelyevEntities();
            }

            return _context;
        }

        public SavelyevEntities()
            : base("name=SavelyevEntities")
        {
        }
